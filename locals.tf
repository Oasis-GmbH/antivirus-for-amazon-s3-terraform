locals {
  ...
  # URL = "${var.configure_load_balancer}" ? "https://${var.alb_domain}" : "https://${var.aws_account}-${aws_appconfig_application.AppConfigAgentApplication.id}.cloudstoragesecapp.com"
